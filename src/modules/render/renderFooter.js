...
const createFooterCategory = () => {
	...
	for (const key in DATA.navigation) {
		const footerCategotyItem = createElement(
			'li',
			{
		...
		`
            <div class="footer__item footer__item_social footer-social">
                ...
                <ul class="footer-social__list">
                    <li class="footer-social__item">
                        <a href="" class="footer__link footer-social__link footer-social__link_vk" target="_blank">
                    ...
                    <li class="footer-social__item">
                        <a href="" class="footer__link footer-social__link footer-social__link_fb" target="_blank">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="footer__item footer__item_development footer-development">
                <ul class="footer-development__list">
                    <li class="footer-development__item">Designer:
                        <a href="https://t.me/Mrshmallowww" class="footer__link" target="_blank">Anastasia Ilina</a>
                    </li>
                    <li class="footer-development__item">Developer:
                        <a href="https://t.me/VladLesun" class="footer__link" target="_blank">Vlad Lesun</a>
                    </li>
                </ul>
            </div>
        `
